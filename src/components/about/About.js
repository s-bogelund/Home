		...
		<div className="a">
			...
			<div className="a-right">
				...
				<p className="a-desc1">
					...
					interessant.
					<br />
					Derimod er jeg rigtig glad for højere niveau softwareudvikling, og derfor har jeg brugt en god del af min fritid på at lære nye værktøjer, og det har været virkelig motiverende.
					
					<br/> Jeg er især blevet glad for C# som jeg startede med at bruge i sommeren 2021, og som jeg bl.a. brugte til selvstændigt at stå for en GUI i WPF til 3. semesters projekt.
					<br />
